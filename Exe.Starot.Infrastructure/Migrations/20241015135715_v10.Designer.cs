            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.CustomerEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "customer1",
                            CreatedDate = new DateTime(2024, 10, 15, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(6541),
                            LastUpdated = new DateTime(2024, 10, 15, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(6541),
                            Membership = 0,
                            UserId = "user1"
                        });
                });
            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.ReaderEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "reader1",
                            CreatedDate = new DateTime(2024, 10, 15, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(6588),
                            ...
                            LastUpdated = new DateTime(2024, 10, 15, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(6588),
            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = "user1",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 15, 13, 57, 13, 51, DateTimeKind.Utc).AddTicks(425),
                            ...
                            Image = "",
                            LastName = "Doe",
                            LastUpdated = new DateTime(2024, 10, 15, 13, 57, 13, 51, DateTimeKind.Utc).AddTicks(425),
                            PasswordHash = "$2a$11$JPRY9GAWJg7MZEPS2BIzsu1ER9dwQqkMj6rP6yCsbDoH3aC5bVe8.",
                            Phone = "123456789",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 14, 13, 57, 13, 185, DateTimeKind.Utc).AddTicks(8143),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 15, 13, 57, 13, 185, DateTimeKind.Utc).AddTicks(8156),
                            Role = "Customer"
                        },
                        new
                        {
                            ID = "user2",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 15, 13, 57, 13, 185, DateTimeKind.Utc).AddTicks(8271),
                            DateOfBirth = "20/11/2020",
                            ...
                            Image = "",
                            LastName = "Smith",
                            LastUpdated = new DateTime(2024, 10, 15, 13, 57, 13, 185, DateTimeKind.Utc).AddTicks(8271),
                            PasswordHash = "$2a$11$vyWT2lTexkmG1orvDvBSL.8R9z/Zaj6Ur8FWR3rtuwXO1zN0gsPGm",
                            Phone = "987654321",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 14, 13, 57, 13, 325, DateTimeKind.Utc).AddTicks(1176),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 15, 13, 57, 13, 325, DateTimeKind.Utc).AddTicks(1185),
                            Role = "Reader"
                        },
                        new
                        {
                            ID = "admin",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 15, 13, 57, 13, 325, DateTimeKind.Utc).AddTicks(1302),
                            DateOfBirth = "20/11/2020",
                            ...
                            Image = "",
                            LastName = "Admin",
                            LastUpdated = new DateTime(2024, 10, 15, 13, 57, 13, 325, DateTimeKind.Utc).AddTicks(1302),
                            PasswordHash = "$2a$11$xY5NjaMlv0JQi6A57aITOeMsojxXd.bcrrQUZooWTo8Mn.A.2r4UK",
                            Phone = "123456789",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 14, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(5614),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 15, 13, 57, 13, 457, DateTimeKind.Utc).AddTicks(5622),
                            Role = "Admin"
                        });
                });
