            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.CustomerEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "customer1",
                            CreatedDate = new DateTime(2024, 10, 13, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(5043),
                            LastUpdated = new DateTime(2024, 10, 13, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(5043),
                            Membership = 0,
                            UserId = "user1"
                        });
                });
            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.ReaderEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "reader1",
                            CreatedDate = new DateTime(2024, 10, 13, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(5086),
                            ...
                            LastUpdated = new DateTime(2024, 10, 13, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(5086),
            ...
            modelBuilder.Entity("Exe.Starot.Domain.Entities.Base.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = "user1",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 13, 16, 33, 48, 770, DateTimeKind.Utc).AddTicks(6987),
                            ...
                            Image = "",
                            LastName = "Doe",
                            LastUpdated = new DateTime(2024, 10, 13, 16, 33, 48, 770, DateTimeKind.Utc).AddTicks(6987),
                            PasswordHash = "$2a$11$3x3xI8fKcGfo5AEnQJgIp.Ads6ls7iT5ZZMfQXhw05bVtSRK7uRVC",
                            Phone = "123456789",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 12, 16, 33, 48, 905, DateTimeKind.Utc).AddTicks(4502),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 13, 16, 33, 48, 905, DateTimeKind.Utc).AddTicks(4513),
                            Role = "Customer"
                        },
                        new
                        {
                            ID = "user2",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 13, 16, 33, 48, 905, DateTimeKind.Utc).AddTicks(4635),
                            DateOfBirth = "20/11/2020",
                            ...
                            Image = "",
                            LastName = "Smith",
                            LastUpdated = new DateTime(2024, 10, 13, 16, 33, 48, 905, DateTimeKind.Utc).AddTicks(4635),
                            PasswordHash = "$2a$11$Gx64bL52Xkj8vSvjBOpqG.jBiJsMvTrfACnMShaxbTd3XIZX1MWhi",
                            Phone = "987654321",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 12, 16, 33, 49, 42, DateTimeKind.Utc).AddTicks(695),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 13, 16, 33, 49, 42, DateTimeKind.Utc).AddTicks(704),
                            Role = "Reader"
                        },
                        new
                        {
                            ID = "admin",
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 10, 13, 16, 33, 49, 42, DateTimeKind.Utc).AddTicks(817),
                            DateOfBirth = "20/11/2020",
                            ...
                            Image = "",
                            LastName = "Admin",
                            LastUpdated = new DateTime(2024, 10, 13, 16, 33, 49, 42, DateTimeKind.Utc).AddTicks(817),
                            PasswordHash = "$2a$11$VuPyhyN7bQNZuFpRqKtFK.I4AJ.IzvB5zvkjBnafWZE8NkKGHUciW",
                            Phone = "123456789",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 12, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(4236),
                            RefreshTokenIssuedAt = new DateTime(2024, 10, 13, 16, 33, 49, 176, DateTimeKind.Utc).AddTicks(4244),
                            Role = "Admin"
                        });
                });
